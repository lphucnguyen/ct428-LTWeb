            ...
            <div class="card-body">
                <form action="./modules/product/process.php" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        <label>MSHH</label>
                        <input type="text" name="MSHH" class="form-control" value="<?=$result["MSHH"]?>" />
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="maloai">
                            ...
                            ?>  
                                <option value="<?=$row["MaLoaiHang"]?>" <?=($row["MaLoaiHang"] == $result["MaLoaiHang"]) ? "selected" : ""?>><?=$row["TenLoaiHang"]?></option>
                            <?php
                                endwhile;
                            ?>
                        </select>
