                                ...
                                <form action="includes/process.php?" method="GET">
                                    ...
                                    <div class="price-button">
                                        <div class="price_content">
                                            <span class="new-price-product"><?= $row["Gia"] ?></span>
        ...
        <section id="related-product">
            <div class="container">
                ...
                <div class="product-items product-related d-flex">
                    ...
                    <?php
                    $sql2 = "SELECT * FROM HANGHOA WHERE MaLoaiHang='" . $loaihang . "';";
                    $result2 = mysqli_query($db, $sql2);
                    $row2 = mysqli_fetch_assoc($result2);
                    while ($row2 = mysqli_fetch_assoc($result2)) {
                        $sql1 = "SELECT * FROM HINHHANGHOA WHERE MSHH='" . $row["MSHH"] . "';";
                        $result1 = mysqli_query($db, $sql1);
                        $row1 = mysqli_fetch_assoc($result1);
                    ...
                    <div class="product-item_desc">
                        ...
                        <span class="product-item_desc-price_new">' . $row2["Gia"] . ' VND</span>
